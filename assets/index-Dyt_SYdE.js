var U=t=>{throw TypeError(t)};var x=(t,e,n)=>e.has(t)||U("Cannot "+n);var d=(t,e,n)=>(x(t,e,"read from private field"),n?n.call(t):e.get(t)),m=(t,e,n)=>e.has(t)?U("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),h=(t,e,n,i)=>(x(t,e,"write to private field"),i?i.call(t,n):e.set(t,n),n),p=(t,e,n)=>(x(t,e,"access private method"),n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const J="https://story-api.dicoding.dev/v1",ae="BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk";async function q(t){try{if(await Notification.requestPermission()!=="granted"){alert("Notifikasi tidak dapat diaktifkan saat ini. Silakan muat ulang halaman atau periksa izin notifikasi di browser Anda.");return}const n=await t.pushManager.getSubscription();n&&(await n.unsubscribe(),console.log("[Push] Subscription lama dihapus."));const i=oe(ae),a=await t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:i}),o=localStorage.getItem("token");if(!o)throw new Error("Token login tidak ditemukan");if(!(await fetch(`${J}/notifications/subscribe`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify({endpoint:a.endpoint,keys:a.toJSON().keys})})).ok)throw new Error("Gagal mengirim subscription ke server");await Y("Notifikasi Diaktifkan","Kamu akan menerima notifikasi cerita baru 🎉"),console.log("[Push] Subscription berhasil.")}catch(e){console.error("[Push] Gagal aktifkan:",e.message),alert("Notifikasi tidak dapat diaktifkan saat ini. Silakan muat ulang halaman atau periksa izin notifikasi di browser Anda.")}}async function ie(t){try{const e=await t.pushManager.getSubscription();if(!e){alert("Tidak ada notifikasi yang aktif.");return}const n=localStorage.getItem("token");if(!n){alert("Token login tidak ditemukan");return}if(!(await fetch(`${J}/notifications/subscribe`,{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify({endpoint:e.endpoint})})).ok)throw new Error("Gagal hapus subscription di server");await e.unsubscribe()?(await Y("Notifikasi Dimatikan","Kamu tidak akan menerima notifikasi lagi 🔕"),console.log("[Push] Unsubscribe berhasil.")):alert("Gagal menonaktifkan notifikasi")}catch(e){console.error("[Push] Gagal unsubscribe:",e.message),alert("Notifikasi tidak dapat dimatikan saat ini. Silakan muat ulang halaman.")}}async function Y(t,e){if(Notification.permission!=="granted"){alert(`${t}
${e}`);return}(await navigator.serviceWorker.ready).showNotification(t,{body:e,icon:"/images/android-chrome-192x192.png",badge:"/images/android-chrome-192x192.png"})}function oe(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/-/g,"+").replace(/_/g,"/"),i=atob(n);return new Uint8Array([...i].map(a=>a.charCodeAt(0)))}const re={BASE_URL:"https://story-api.dicoding.dev/v1"},T=re.BASE_URL;async function se(){const t=localStorage.getItem("token");return(await(await fetch(`${T}/stories`,{headers:{Authorization:`Bearer ${t}`}})).json()).listStory||[]}async function ce({description:t,photo:e,lat:n,lon:i}){const a=localStorage.getItem("token"),o=new FormData;return o.append("description",t),o.append("photo",e),n&&i&&(o.append("lat",n),o.append("lon",i)),await(await fetch(`${T}/stories`,{method:"POST",headers:{Authorization:`Bearer ${a}`},body:o})).json()}async function de({email:t,password:e}){return await(await fetch(`${T}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:e})})).json()}async function le({name:t,email:e,password:n}){return await(await fetch(`${T}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,email:e,password:n})})).json()}async function ue(t){const e=localStorage.getItem("token");return(await(await fetch(`https://story-api.dicoding.dev/v1/stories/${t}`,{headers:{Authorization:`Bearer ${e}`}})).json()).story}function me(t){typeof(t==null?void 0:t.onLoading)=="function"&&t.onLoading(),se().then(e=>{typeof(t==null?void 0:t.onSuccess)=="function"&&t.onSuccess(e)}).catch(e=>{console.error("Gagal mengambil data cerita:",e),typeof(t==null?void 0:t.onError)=="function"&&t.onError(e)})}function pe({description:t,photo:e,lat:n,lon:i}){return ce({description:t,photo:e,lat:n,lon:i})}class ge{async render(){return`
    ...
    `}async afterRender(){const e=document.querySelector("#register-form"),n=document.querySelector("#register-message");e.addEventListener("submit",i=>{i.preventDefault();const a=e.name.value,o=e.email.value,r=e.password.value;ve(a,o,r,c=>{n.textContent=c.message,e.reset(),setTimeout(()=>{location.hash="#/login"},1500)},c=>{n.textContent=c.message})})}}function Z(t){const e=t.split("/");return{resource:e[1]||null,id:e[2]||null}}function Le(t){let e="";return t.resource&&(e=e.concat(`/${t.resource}`)),t.id&&(e=e.concat("/:id")),e||"/"}function Q(){return location.hash.replace("#","")||"/"}function Se(){const t=Q(),e=Z(t);return Le(e)}function Ee(){const t=Q();return Z(t)}var b;class Ie{constructor(e){m(this,b);h(this,b,e)}async showDetail(e){try{const n=await ue(e);n?d(this,b).displayStory(n):d(this,b).displayError("Cerita tidak ditemukan.")}catch(n){console.error(n),d(this,b).displayError("Gagal mengambil data cerita.")}}}b=new WeakMap;const N=(t,e)=>e.some(n=>t instanceof n);let _,z;function Be(){return _||(_=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function De(){return z||(z=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const R=new WeakMap,$=new WeakMap,A=new WeakMap;function Me(t){const e=new Promise((n,i)=>{const a=()=>{t.removeEventListener("success",o),t.removeEventListener("error",r)},o=()=>{n(w(t.result)),a()},r=()=>{i(t.error),a()};t.addEventListener("success",o),t.addEventListener("error",r)});return A.set(e,t),e}function Pe(t){if(R.has(t))return;const e=new Promise((n,i)=>{const a=()=>{t.removeEventListener("complete",o),t.removeEventListener("error",r),t.removeEventListener("abort",r)},o=()=>{n(),a()},r=()=>{i(t.error||new DOMException("AbortError","AbortError")),a()};t.addEventListener("complete",o),t.addEventListener("error",r),t.addEventListener("abort",r)});R.set(t,e)}let j={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return R.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return w(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function X(t){j=t(j)}function Te(t){return De().includes(t)?function(...e){return t.apply(F(this),e),w(this.request)}:function(...e){return w(t.apply(F(this),e))}}function Ae(t){return typeof t=="function"?Te(t):(t instanceof IDBTransaction&&Pe(t),N(t,Be())?new Proxy(t,j):t)}function w(t){if(t instanceof IDBRequest)return Me(t);if($.has(t))return $.get(t);const e=Ae(t);return e!==t&&($.set(t,e),A.set(e,t)),e}const F=t=>A.get(t);function Ce(t,e,{blocked:n,upgrade:i,blocking:a,terminated:o}={}){const r=indexedDB.open(t,e),c=w(r);return i&&r.addEventListener("upgradeneeded",s=>{i(w(r.result),s.oldVersion,s.newVersion,w(r.transaction),s)}),n&&r.addEventListener("blocked",s=>n(s.oldVersion,s.newVersion,s)),c.then(s=>{o&&s.addEventListener("close",()=>o()),a&&s.addEventListener("versionchange",l=>a(l.oldVersion,l.newVersion,l))}).catch(()=>{}),c}const xe=["get","getKey","getAll","getAllKeys","count"],$e=["put","add","delete","clear"],O=new Map;function G(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(O.get(e))return O.get(e);const n=e.replace(/FromIndex$/,""),i=e!==n,a=$e.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!(a||xe.includes(n)))return;const o=async function(r,...c){const s=this.transaction(r,a?"readwrite":"readonly");let l=s.store;return i&&(l=l.index(c.shift())),(await Promise.all([l[n](...c),a&&s.done]))[0]};return O.set(e,o),o}X(t=>({...t,get:(e,n,i)=>G(e,n)||t.get(e,n,i),has:(e,n)=>!!G(e,n)||t.has(e,n)}));const Oe=["continue","continuePrimaryKey","advance"],V={},H=new WeakMap,ee=new WeakMap,Ne={get(t,e){if(!Oe.includes(e))return t[e];let n=V[e];return n||(n=V[e]=function(...i){H.set(this,ee.get(this)[e](...i))}),n}};async function*Re(...t){let e=this;if(e instanceof IDBCursor||(e=await e.openCursor(...t)),!e)return;e=e;const n=new Proxy(e,Ne);for(ee.set(n,e),A.set(n,F(e));e;)yield n,e=await(H.get(n)||e.continue()),H.delete(n)}function W(t,e){return e===Symbol.asyncIterator&&N(t,[IDBIndex,IDBObjectStore,IDBCursor])||e==="iterate"&&N(t,[IDBIndex,IDBObjectStore])}X(t=>({...t,get(e,n,i){return W(e,n)?Re:t.get(e,n,i)},has(e,n){return W(e,n)||t.has(e,n)}}));const je="dicoding-story-db",Fe=1,k="stories",C=()=>Ce(je,Fe,{upgrade(t){if(!t.objectStoreNames.contains(k)){const e=t.createObjectStore(k,{keyPath:"id"});e.createIndex("name","name",{unique:!1}),e.createIndex("createdAt","createdAt",{unique:!1}),console.log(`[IndexedDB] Object store "${k}" dibuat.`)}}}),He=async t=>{if(!t||!t.id)throw new Error("Cerita tidak memiliki ID.");await(await C()).put(k,t),console.log(`[IndexedDB] Cerita "${t.id}" disimpan.`)},Ue=async()=>{const e=await(await C()).getAll(k);return console.log(`[IndexedDB] Mengambil ${e.length} cerita.`),e},qe=async t=>{const n=await(await C()).get(k,t);return console.log(`[IndexedDB] Cerita ID "${t}" ditemukan:`,!!n),n},_e=async t=>{await(await C()).delete(k,t),console.log(`[IndexedDB] Cerita ID "${t}" dihapus.`)};var M,S,P;class ze{constructor(){m(this,S);m(this,M)}async render(){return`
      <section class="container">
    ...
    `}async afterRender(){const{id:e}=Ee();h(this,M,new Ie(this)),d(this,M).showDetail(e)}async displayStory(e){const n=document.getElementById("story-detail");n.innerHTML=`
    ...
    `}async afterRender(){const e=document.getElementById("favorites-list"),n=await Ue();if(!n.length){e.innerHTML='<p style="text-align:center;">Tidak ada cerita favorit.</p>';return}n.forEach(i=>{const a=document.createElement("div");a.className="story-card",a.innerHTML=`
      ...
      `,a.addEventListener("click",()=>{location.hash=`#/story/${i.id}`}),e.appendChild(a)})}}class Ve{async render(){return`
      <section class="not-found-page">
        <h2>404 - Halaman Tidak Ditemukan</h2>
        <p>Maaf, halaman yang kamu cari tidak tersedia.</p>
        <a href="#/">Kembali ke Beranda</a>
      </section>
    `}async afterRender(){}}const K={"/":new ge,"/about":new fe,"/add":new ye,"/login":new we,"/register":new ke,"/favorites":new Ge,"/story/:id":new ze,"*":new Ve};var v,E,f,u,te,I,ne;class We{constructor({navigationDrawer:e,drawerButton:n,content:i}){m(this,u);m(this,v,null);m(this,E,null);m(this,f,null);h(this,v,i),h(this,E,n),h(this,f,e),p(this,u,te).call(this),p(this,u,I).call(this),p(this,u,ne).call(this)}async renderPage(){const e=Se(),n=K[e]||K["*"];if(!n){d(this,v).innerHTML="<h2>Terjadi kesalahan: route tidak dikenali.</h2>";return}document.startViewTransition?document.startViewTransition(async()=>{d(this,v).innerHTML=await n.render(),await n.afterRender(),p(this,u,I).call(this)}):(d(this,v).innerHTML=await n.render(),await n.afterRender(),p(this,u,I).call(this))}}v=new WeakMap,E=new WeakMap,f=new WeakMap,u=new WeakSet,te=function(){d(this,E).addEventListener("click",()=>{d(this,f).classList.toggle("open")}),document.body.addEventListener("click",e=>{!d(this,f).contains(e.target)&&!d(this,E).contains(e.target)&&d(this,f).classList.remove("open"),d(this,f).querySelectorAll("a").forEach(n=>{n.contains(e.target)&&d(this,f).classList.remove("open")})})},I=function(){const e=document.querySelector("#auth-nav");if(e)if(localStorage.getItem("token")){const n=localStorage.getItem("name")||"User";e.innerHTML=`<a href="#" id="logout-link">Logout (${n})</a>`,document.querySelector("#logout-link").addEventListener("click",i=>{i.preventDefault(),localStorage.removeItem("token"),localStorage.removeItem("name"),location.hash="#/",p(this,u,I).call(this)})}else e.innerHTML='<a href="#/login">Login</a>'},ne=function(){const e=document.querySelector(".brand-name");e&&e.addEventListener("click",n=>{n.preventDefault(),location.hash="#/",setTimeout(()=>{const i=document.getElementById("main-content");i&&i.focus()},200)})};document.addEventListener("DOMContentLoaded",async()=>{const t=new We({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")});await t.renderPage(),window.addEventListener("hashchange",async()=>{await t.renderPage()});const e=document.getElementById("toggle-push-btn");async function n(){return!!await(await navigator.serviceWorker.ready).pushManager.getSubscription()}async function i(a){if(e){if(Notification.permission==="denied"){e.style.display="none";return}e.style.display="inline-block",a?(e.classList.remove("off"),e.classList.add("on"),e.innerHTML='<i class="fa-solid fa-bell-slash"></i> Matikan Notifikasi',e.dataset.state="on"):(e.classList.remove("on"),e.classList.add("off"),e.innerHTML='<i class="fa-solid fa-bell"></i> Aktifkan Notifikasi',e.dataset.state="off")}}if("serviceWorker"in navigator&&"PushManager"in window)try{const a=await navigator.serviceWorker.register("/Dicoding_Story-/sw.js");console.log("✅ Service Worker berhasil didaftarkan:",a.scope);const o=Notification.permission;o==="granted"?(await n()||(console.log("🔔 Notifikasi diizinkan tapi belum langganan. Melakukan auto subscribe..."),await q(a)),await i(!0)):o==="default"?await i(!1):e.style.display="none",e&&e.addEventListener("click",async()=>{const r=e.dataset.state;if(Notification.permission==="default"&&await Notification.requestPermission()!=="granted"){alert("Izin notifikasi diperlukan.");return}e.dataset.state==="on"?await ie(a):await q(a),await i(await n())})}catch(a){console.error("❌ Gagal mendaftarkan Service Worker:",a)}});
