var B=t=>{throw TypeError(t)};var T=(t,e,a)=>e.has(t)||B("Cannot "+a);var s=(t,e,a)=>(T(t,e,"read from private field"),a?a.call(t):e.get(t)),c=(t,e,a)=>e.has(t)?B("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),p=(t,e,a,o)=>(T(t,e,"write to private field"),o?o.call(t,a):e.set(t,a),a),h=(t,e,a)=>(T(t,e,"access private method"),a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();const O="https://story-api.dicoding.dev/v1",$="BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk";async function R(t){try{const e=await Notification.requestPermission();if(console.log("[Push] Permission:",e),e!=="granted"){console.warn("[Push] Izin ditolak");return}const a=await t.pushManager.getSubscription();if(a){console.log("[Push] Sudah subscribe:",a);return}const o=urlBase64ToUint8Array($),n=await t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:o});console.log("[Push] pushSubscription:",n);const i=localStorage.getItem("token");if(!i)throw new Error("Token login tidak ditemukan");if(!(await fetch(`${O}/notifications/subscribe`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:JSON.stringify({endpoint:n.endpoint,keys:n.toJSON().keys})})).ok)throw new Error("Gagal mengirim subscription");console.log("[Push] Subscription berhasil!")}catch(e){console.error("[Push] Gagal:",e.message||e)}}const q={BASE_URL:"https://story-api.dicoding.dev/v1"},E=q.BASE_URL;async function M(){const t=localStorage.getItem("token");return(await(await fetch(`${E}/stories`,{headers:{Authorization:`Bearer ${t}`}})).json()).listStory||[]}async function U({description:t,photo:e,lat:a,lon:o}){const n=localStorage.getItem("token"),i=new FormData;return i.append("description",t),i.append("photo",e),a&&o&&(i.append("lat",a),i.append("lon",o)),await(await fetch(`${E}/stories`,{method:"POST",headers:{Authorization:`Bearer ${n}`},body:i})).json()}async function H({email:t,password:e}){return await(await fetch(`${E}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:e})})).json()}async function j({name:t,email:e,password:a}){return await(await fetch(`${E}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,email:e,password:a})})).json()}function N(t){typeof(t==null?void 0:t.onLoading)=="function"&&t.onLoading(),M().then(e=>{typeof(t==null?void 0:t.onSuccess)=="function"&&t.onSuccess(e)}).catch(e=>{console.error("Gagal mengambil data cerita:",e),typeof(t==null?void 0:t.onError)=="function"&&t.onError(e)})}function _({description:t,photo:e,lat:a,lon:o}){return U({description:t,photo:e,lat:a,lon:o})}class z{async render(){return`
    ...
    `}async afterRender(){const e=document.querySelector("#login-form"),a=document.querySelector("#login-message");e.addEventListener("submit",o=>{o.preventDefault();const n=e.email.value,i=e.password.value;K(n,i,r=>{a.textContent=r.message,localStorage.setItem("token",r.loginResult.token),localStorage.setItem("name",r.loginResult.name),window.location.hash="#/"},r=>{a.textContent=r.message})})}}class Y{async render(){return`
      <section class="login-page">
        <div class="login-box">
          <h2>Daftar Akun</h2>
    ...
    `}async afterRender(){const e=document.querySelector("#register-form"),a=document.querySelector("#register-message");e.addEventListener("submit",o=>{o.preventDefault();const n=e.name.value,i=e.email.value,r=e.password.value;W(n,i,r,m=>{a.textContent=m.message,e.reset(),setTimeout(()=>{location.hash="#/login"},1500)},m=>{a.textContent=m.message})})}}function A(t){const e=t.split("/");return{resource:e[1]||null,id:e[2]||null}}function Z(t){let e="";return t.resource&&(e=e.concat(`/${t.resource}`)),t.id&&(e=e.concat("/:id")),e||"/"}function x(){return location.hash.replace("#","")||"/"}function Q(){const t=x(),e=A(t);return Z(e)}function X(){const t=x();return A(t)}var f;class ee{constructor(e){c(this,f);p(this,f,e)}async showDetail(e){try{const o=(await M()).find(n=>n.id===e);o?s(this,f).displayStory(o):s(this,f).displayError("Cerita tidak ditemukan.")}catch{s(this,f).displayError("Gagal mengambil data cerita.")}}}f=new WeakMap;var k;class te{constructor(){c(this,k)}async render(){return`
      <section class="container">
