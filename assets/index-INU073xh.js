var B=t=>{throw TypeError(t)};var I=(t,e,a)=>e.has(t)||B("Cannot "+a);var s=(t,e,a)=>(I(t,e,"read from private field"),a?a.call(t):e.get(t)),d=(t,e,a)=>e.has(t)?B("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),p=(t,e,a,i)=>(I(t,e,"write to private field"),i?i.call(t,a):e.set(t,a),a),h=(t,e,a)=>(I(t,e,"access private method"),a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const O="https://story-api.dicoding.dev/v1",$="BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk";async function R(t){var e;try{const a=await Notification.requestPermission();if(console.log("[Push] Permission:",a),a!=="granted")return;const i=await t.pushManager.getSubscription();if(i){console.log("[Push] Sudah subscribe:",i);return}const n=q($),o=await t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:n}),r=(e=o==null?void 0:o.toJSON)==null?void 0:e.call(o).keys;if(!r||!r.p256dh||!r.auth)throw new Error("Push subscription keys tidak tersedia.");const l=localStorage.getItem("token");if(!l)throw new Error("Token login tidak ditemukan");if(!(await fetch(`${O}/notifications/subscribe`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${l}`},body:JSON.stringify({endpoint:o.endpoint,keys:{p256dh:r.p256dh,auth:r.auth}})})).ok)throw new Error("Gagal mengirim subscription");console.log("[Push] Subscription berhasil!")}catch(a){console.error("[Push] Gagal:",a.message)}}function q(t){const e="=".repeat((4-t.length%4)%4),a=(t+e).replace(/-/g,"+").replace(/_/g,"/"),i=atob(a);return new Uint8Array([...i].map(n=>n.charCodeAt(0)))}const U={BASE_URL:"https://story-api.dicoding.dev/v1"},P=U.BASE_URL;async function M(){const t=localStorage.getItem("token");return(await(await fetch(`${P}/stories`,{headers:{Authorization:`Bearer ${t}`}})).json()).listStory||[]}async function H({description:t,photo:e,lat:a,lon:i}){const n=localStorage.getItem("token"),o=new FormData;return o.append("description",t),o.append("photo",e),a&&i&&(o.append("lat",a),o.append("lon",i)),await(await fetch(`${P}/stories`,{method:"POST",headers:{Authorization:`Bearer ${n}`},body:o})).json()}async function j({email:t,password:e}){return await(await fetch(`${P}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:e})})).json()}async function _({name:t,email:e,password:a}){return await(await fetch(`${P}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,email:e,password:a})})).json()}function N(t){typeof(t==null?void 0:t.onLoading)=="function"&&t.onLoading(),M().then(e=>{typeof(t==null?void 0:t.onSuccess)=="function"&&t.onSuccess(e)}).catch(e=>{console.error("Gagal mengambil data cerita:",e),typeof(t==null?void 0:t.onError)=="function"&&t.onError(e)})}function z({description:t,photo:e,lat:a,lon:i}){return H({description:t,photo:e,lat:a,lon:i})}class F{async render(){return`
    ...
    `:(setTimeout(()=>{window.location.hash="#/login"},100),'<section class="container"><p>Anda harus login untuk menambahkan cerita.</p></section>')}async afterRender(){const e=document.getElementById("preview-container"),a=n=>{const o=new FileReader;o.onload=r=>{e.innerHTML=`<img src="${r.target.result}" alt="Preview" style="max-width:100%; border-radius:6px;" />`},o.readAsDataURL(n)};document.getElementById("open-folder").addEventListener("click",()=>{document.getElementById("file-input").click()}),document.getElementById("file-input").addEventListener("change",n=>{m=n.target.files[0],a(m)});const i=/Android|iPhone|iPad|iPod/i.test(navigator.userAgent);document.getElementById("open-camera").addEventListener("click",async()=>{if(i)document.getElementById("mobile-camera-input").click();else{const n=document.getElementById("webcam-container"),o=document.getElementById("webcam"),r=document.getElementById("snapshot"),l=document.getElementById("capture-photo");n.style.display="block";try{g=await navigator.mediaDevices.getUserMedia({video:!0}),o.srcObject=g}catch(E){alert("Tidak dapat mengakses webcam: "+E.message)}l.onclick=()=>{const E=r.getContext("2d");r.width=o.videoWidth,r.height=o.videoHeight,E.drawImage(o,0,0),r.toBlob(T=>{m=new File([T],"webcam-capture.jpg",{type:"image/jpeg"}),a(m)},"image/jpeg"),g&&(g.getTracks().forEach(T=>T.stop()),o.srcObject=null,g=null),n.style.display="none"}}}),document.getElementById("mobile-camera-input").addEventListener("change",n=>{m=n.target.files[0],a(m)}),J("map",(n,o)=>{p(this,w,n),p(this,k,o)}),window.addEventListener("hashchange",()=>{g&&(g.getTracks().forEach(n=>n.stop()),g=null)}),document.getElementById("story-form").addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("form-message");o.textContent="Mengirim...";const r=document.getElementById("description").value;if(!m){o.textContent="Silakan pilih atau ambil foto terlebih dahulu.";return}const l=await z({description:r,photo:m,lat:s(this,w),lon:s(this,k)});l.error?o.textContent=`Gagal: ${l.message}`:(o.textContent="Cerita berhasil dikirim!",n.target.reset(),e.innerHTML="",m=null,this.marker&&map.removeLayer(this.marker),setTimeout(()=>{location.hash="#/"},1500))})}}w=new WeakMap,k=new WeakMap;async function W(t,e,a,i){try{const n=await j({email:t,password:e});a(n)}catch(n){console.error("Login gagal:",n),i({error:!0,message:"Login gagal. Silakan coba lagi."})}}async function V(t,e,a,i,n){try{const o=await _({name:t,email:e,password:a});i(o)}catch(o){console.error("Registrasi gagal:",o),n({error:!0,message:"Registrasi gagal. Silakan coba lagi."})}}class Y{async render(){return`
    ...
    `}async afterRender(){const e=document.querySelector("#login-form"),a=document.querySelector("#login-message");e.addEventListener("submit",i=>{i.preventDefault();const n=e.email.value,o=e.password.value;W(n,o,r=>{a.textContent=r.message,localStorage.setItem("token",r.loginResult.token),localStorage.setItem("name",r.loginResult.name),window.location.hash="#/"},r=>{a.textContent=r.message})})}}class Z{async render(){return`
      <section class="login-page">
        <div class="login-box">
          <h2>Daftar Akun</h2>
    ...
    `}async afterRender(){const e=document.querySelector("#register-form"),a=document.querySelector("#register-message");e.addEventListener("submit",i=>{i.preventDefault();const n=e.name.value,o=e.email.value,r=e.password.value;V(n,o,r,l=>{a.textContent=l.message,e.reset(),setTimeout(()=>{location.hash="#/login"},1500)},l=>{a.textContent=l.message})})}}function A(t){const e=t.split("/");return{resource:e[1]||null,id:e[2]||null}}function Q(t){let e="";return t.resource&&(e=e.concat(`/${t.resource}`)),t.id&&(e=e.concat("/:id")),e||"/"}function x(){return location.hash.replace("#","")||"/"}function X(){const t=x(),e=A(t);return Q(e)}function ee(){const t=x();return A(t)}var f;class te{constructor(e){d(this,f);p(this,f,e)}async showDetail(e){try{const i=(await M()).find(n=>n.id===e);i?s(this,f).displayStory(i):s(this,f).displayError("Cerita tidak ditemukan.")}catch{s(this,f).displayError("Gagal mengambil data cerita.")}}}f=new WeakMap;var S;class ae{constructor(){d(this,S)}async render(){return`
      <section class="container">
    ...
    `,document.querySelector(".story-detail-image").animate([{opacity:0,transform:"scale(0.95)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"ease-out"})}displayError(e){const a=document.getElementById("story-detail");a.innerHTML=`<p style="color:red;">${e}</p>`}}S=new WeakMap;const ne={"/":new F,"/about":new G,"/add":new K,"/login":new Y,"/register":new Z,"/story/:id":new ae};var y,b,u,c,D,v,C;class oe{constructor({navigationDrawer:e,drawerButton:a,content:i}){d(this,c);d(this,y,null);d(this,b,null);d(this,u,null);p(this,y,i),p(this,b,a),p(this,u,e),h(this,c,D).call(this),h(this,c,v).call(this),h(this,c,C).call(this)}async renderPage(){const e=X(),a=ne[e];document.startViewTransition?document.startViewTransition(async()=>{s(this,y).innerHTML=await a.render(),await a.afterRender(),h(this,c,v).call(this)}):(s(this,y).innerHTML=await a.render(),await a.afterRender(),h(this,c,v).call(this))}}y=new WeakMap,b=new WeakMap,u=new WeakMap,c=new WeakSet,D=function(){s(this,b).addEventListener("click",()=>{s(this,u).classList.toggle("open")}),document.body.addEventListener("click",e=>{!s(this,u).contains(e.target)&&!s(this,b).contains(e.target)&&s(this,u).classList.remove("open"),s(this,u).querySelectorAll("a").forEach(a=>{a.contains(e.target)&&s(this,u).classList.remove("open")})})},v=function(){const e=document.querySelector("#auth-nav");if(e)if(localStorage.getItem("token")){const a=localStorage.getItem("name")||"User";e.innerHTML=`<a href="#" id="logout-link">Logout (${a})</a>`,document.querySelector("#logout-link").addEventListener("click",i=>{i.preventDefault(),localStorage.removeItem("token"),localStorage.removeItem("name"),location.hash="#/",h(this,c,v).call(this)})}else e.innerHTML='<a href="#/login">Login</a>'},C=function(){const e=document.querySelector(".brand-name");e&&e.addEventListener("click",a=>{a.preventDefault(),location.hash="#/",setTimeout(()=>{const i=document.getElementById("main-content");i&&i.focus()},200)})};document.addEventListener("DOMContentLoaded",async()=>{const t=new oe({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")});await t.renderPage(),window.addEventListener("hashchange",async()=>{await t.renderPage()})});"serviceWorker"in navigator&&"PushManager"in window&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/Dicoding_Story-/sw.js").then(t=>{console.log("[Service Worker] Terdaftar:",t.scope),R(t)}).catch(t=>{console.error("[Service Worker] Gagal:",t)})});
