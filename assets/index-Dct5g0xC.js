var I=a=>{throw TypeError(a)};var B=(a,e,t)=>e.has(a)||I("Cannot "+t);var s=(a,e,t)=>(B(a,e,"read from private field"),t?t.call(a):e.get(a)),d=(a,e,t)=>e.has(a)?I("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(a):e.set(a,t),p=(a,e,t,i)=>(B(a,e,"write to private field"),i?i.call(a,t):e.set(a,t),t),h=(a,e,t)=>(B(a,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=t(n);fetch(n.href,o)}})();const $="https://story-api.dicoding.dev/v1",R="BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk";let M=!1;async function q(a){var e;if(!M){M=!0;try{const t=await Notification.requestPermission();if(console.log("[Push] Permission:",t),t!=="granted")return;const i=await a.pushManager.getSubscription();if(i){console.log("[Push] Sudah subscribe:",i);return}const n=U(R),o=await a.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:n}),r=(e=o==null?void 0:o.toJSON)==null?void 0:e.call(o).keys;if(!r||!r.p256dh||!r.auth)throw new Error("Push subscription keys tidak tersedia.");const c=localStorage.getItem("token");if(!c)throw new Error("Token login tidak ditemukan");if(!(await fetch(`${$}/notifications/subscribe`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${c}`},body:JSON.stringify({endpoint:o.endpoint,keys:{p256dh:r.p256dh,auth:r.auth}})})).ok)throw new Error("Gagal mengirim subscription");console.log("[Push] Subscription berhasil!")}catch(t){console.error("[Push] Gagal:",t.message)}}}async function H(a){try{const e=await a.pushManager.getSubscription();if(!e){console.warn("[Push] Belum ada subscription aktif.");return}const t=localStorage.getItem("token");if(!t){console.error("[Push] Token tidak ditemukan");return}if(!(await fetch("https://story-api.dicoding.dev/v1/notifications/subscribe",{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({endpoint:e.endpoint})})).ok)throw new Error("Gagal menghapus subscription dari server");await e.unsubscribe()?(console.log("[Push] Berhasil unsubscribe dari browser dan server"),alert("Notifikasi berhasil dimatikan.")):console.warn("[Push] Gagal unsubscribe dari browser")}catch(e){console.error("[Push] Gagal unsubscribe:",e.message)}}function U(a){const e="=".repeat((4-a.length%4)%4),t=(a+e).replace(/-/g,"+").replace(/_/g,"/"),i=atob(t);return new Uint8Array([...i].map(n=>n.charCodeAt(0)))}const N={BASE_URL:"https://story-api.dicoding.dev/v1"},P=N.BASE_URL;async function A(){const a=localStorage.getItem("token");return(await(await fetch(`${P}/stories`,{headers:{Authorization:`Bearer ${a}`}})).json()).listStory||[]}async function j({description:a,photo:e,lat:t,lon:i}){const n=localStorage.getItem("token"),o=new FormData;return o.append("description",a),o.append("photo",e),t&&i&&(o.append("lat",t),o.append("lon",i)),await(await fetch(`${P}/stories`,{method:"POST",headers:{Authorization:`Bearer ${n}`},body:o})).json()}async function _({email:a,password:e}){return await(await fetch(`${P}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:a,password:e})})).json()}async function z({name:a,email:e,password:t}){return await(await fetch(`${P}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:a,email:e,password:t})})).json()}function G(a){typeof(a==null?void 0:a.onLoading)=="function"&&a.onLoading(),A().then(e=>{typeof(a==null?void 0:a.onSuccess)=="function"&&a.onSuccess(e)}).catch(e=>{console.error("Gagal mengambil data cerita:",e),typeof(a==null?void 0:a.onError)=="function"&&a.onError(e)})}function F({description:a,photo:e,lat:t,lon:i}){return j({description:a,photo:e,lat:t,lon:i})}class J{async render(){return`
    ...
    `}async afterRender(){const e=document.querySelector("#register-form"),t=document.querySelector("#register-message");e.addEventListener("submit",i=>{i.preventDefault();const n=e.name.value,o=e.email.value,r=e.password.value;Z(n,o,r,c=>{t.textContent=c.message,e.reset(),setTimeout(()=>{location.hash="#/login"},1500)},c=>{t.textContent=c.message})})}}function x(a){const e=a.split("/");return{resource:e[1]||null,id:e[2]||null}}function ee(a){let e="";return a.resource&&(e=e.concat(`/${a.resource}`)),a.id&&(e=e.concat("/:id")),e||"/"}function C(){return location.hash.replace("#","")||"/"}function te(){const a=C(),e=x(a);return ee(e)}function ae(){const a=C();return x(a)}var f;class ne{constructor(e){d(this,f);p(this,f,e)}async showDetail(e){try{const i=(await A()).find(n=>n.id===e);i?s(this,f).displayStory(i):s(this,f).displayError("Cerita tidak ditemukan.")}catch{s(this,f).displayError("Gagal mengambil data cerita.")}}}f=new WeakMap;var S;class ie{constructor(){d(this,S)}async render(){return`
      <section class="container">
    ...
    `,document.querySelector(".story-detail-image").animate([{opacity:0,transform:"scale(0.95)"},{opacity:1,transform:"scale(1)"}],{duration:300,easing:"ease-out"})}displayError(e){const t=document.getElementById("story-detail");t.innerHTML=`<p style="color:red;">${e}</p>`}}S=new WeakMap;const oe={"/":new J,"/about":new K,"/add":new W,"/login":new Q,"/register":new X,"/story/:id":new ie};var y,b,m,l,D,v,O;class re{constructor({navigationDrawer:e,drawerButton:t,content:i}){d(this,l);d(this,y,null);d(this,b,null);d(this,m,null);p(this,y,i),p(this,b,t),p(this,m,e),h(this,l,D).call(this),h(this,l,v).call(this),h(this,l,O).call(this)}async renderPage(){const e=te(),t=oe[e];document.startViewTransition?document.startViewTransition(async()=>{s(this,y).innerHTML=await t.render(),await t.afterRender(),h(this,l,v).call(this)}):(s(this,y).innerHTML=await t.render(),await t.afterRender(),h(this,l,v).call(this))}}y=new WeakMap,b=new WeakMap,m=new WeakMap,l=new WeakSet,D=function(){s(this,b).addEventListener("click",()=>{s(this,m).classList.toggle("open")}),document.body.addEventListener("click",e=>{!s(this,m).contains(e.target)&&!s(this,b).contains(e.target)&&s(this,m).classList.remove("open"),s(this,m).querySelectorAll("a").forEach(t=>{t.contains(e.target)&&s(this,m).classList.remove("open")})})},v=function(){const e=document.querySelector("#auth-nav");if(e)if(localStorage.getItem("token")){const t=localStorage.getItem("name")||"User";e.innerHTML=`<a href="#" id="logout-link">Logout (${t})</a>`,document.querySelector("#logout-link").addEventListener("click",i=>{i.preventDefault(),localStorage.removeItem("token"),localStorage.removeItem("name"),location.hash="#/",h(this,l,v).call(this)})}else e.innerHTML='<a href="#/login">Login</a>'},O=function(){const e=document.querySelector(".brand-name");e&&e.addEventListener("click",t=>{t.preventDefault(),location.hash="#/",setTimeout(()=>{const i=document.getElementById("main-content");i&&i.focus()},200)})};document.addEventListener("DOMContentLoaded",async()=>{const a=new re({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")});await a.renderPage(),window.addEventListener("hashchange",async()=>{await a.renderPage()});const e=document.getElementById("toggle-push-btn");if(e&&"serviceWorker"in navigator){const t=await navigator.serviceWorker.ready,i=async()=>{await t.pushManager.getSubscription()?(e.innerHTML='<i class="fa-solid fa-bell-slash"></i> Matikan Notifikasi',e.dataset.state="subscribed"):(e.innerHTML='<i class="fa-solid fa-bell"></i> Aktifkan Notifikasi',e.dataset.state="unsubscribed")};await i(),e.addEventListener("click",async()=>{const n=await navigator.serviceWorker.ready;e.dataset.state==="subscribed"?await H(n):await q(n),await i()})}});
